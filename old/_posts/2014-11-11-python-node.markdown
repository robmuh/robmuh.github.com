...
===============================
As beautiful as these languages are, (except PHP which is just so ugly
it turns my stomach), they are dead. They just are. They have lost the
battle for the thing they were best at. PHP lost to Ruby. Ruby lost to
Node. Perl lost to Python3 and Bash. I could write a ton about each, but
those that seriously do their own research will see that same conclusion.
