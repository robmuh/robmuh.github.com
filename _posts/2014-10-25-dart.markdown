...
more suitable for large-scale applications is based on old and inadequate
...
In fact, if you architect this correctly you can rewrite entire small app
components to meet the changing needs of what that component accomplishes
without trashing the entire system. You are still applying object-oriented
thinking just at a higher level than any single app comprising that system.
